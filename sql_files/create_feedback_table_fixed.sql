-- =============================================
-- CREATE FEEDBACK TABLE - MIZRAH BEAUTY (FIXED)
-- =============================================
...
-- Create feedback table with correct foreign key reference
CREATE TABLE feedback (
    ...
    -- Foreign key constraint - FIXED: references users.email instead of users.user_email
...
-- Insert sample feedback data using existing user emails
...
-- Test select
SELECT * FROM feedback WHERE user_email = 'admin@mizrahbeauty.com';
...
PRINT 'Foreign key references users.email (not users.user_email)';
